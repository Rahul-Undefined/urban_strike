...
// ---------------------------------------------------------------------------
/* ===== BASELINE RE-RECORDED FOR v9.10 — a decision, not a convenience =====
   Deliberate, signed-off changes to Urban:
     - 22 building facades recoloured. MATERIALS ONLY — note that `colliders`
       and `tris` below are IDENTICAL to v9.7 and only draws, casters and the
       mesh signature moved. That is the signature of a pure appearance change,
       and it is why nothing about collision, cover or navigation needed
       re-checking.
     - the operator got taller: CFG.PLAYER.standH 1.8 -> 1.92 with every derived
       height and the avatar rig scaled by the same factor.
   CASTERS ARE NOW 62 AGAINST A BUDGET OF 62. There is no headroom left for
   another shadow-casting material on Urban; the next person adding one has to
   free a batch first, not raise the number.
   Recorded with: node tools/verify-untouched.js --record */
const BASELINE = {
  urban: {"colliders":3282,"sum":721674782,"draws":108,"tris":87396,"casters":62,"lights":7,"minimap":208,"bound":100},
