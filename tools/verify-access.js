...
run("urban", [
  ...
  { name: "station upper floor -> third floor 8.25", x: 33.5, y: 4.95, z: -73.2, dx: 0, dz: 1, top: 8.25, ticks: 400 },
  /* v1.0e: the hall is a floor higher — the east-lane flight from the new third floor to the roof */
  { name: "station third floor -> roof 11.55", x: 50.5, y: 8.25, z: -68.0, dx: 0, dz: -1, top: 11.55, ticks: 400 },
