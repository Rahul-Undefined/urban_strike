...
/* v10 SIGN ATLAS - Urban draws 112 -> 98, triangles 92,212 -> 92,092.
  ...
  /* v1.0d: URBAN MOVED ON PURPOSE — Rahul's eight screenshots.
       colliders 4499 -> 4432. What LEFT: the Ship Harbour (quay deck laid over
       the stadium outfield, the 38 m rust hull he called "a wall", the quay
       stair, the ship superstructure and its switchback, the aft deck, the
       gantry crane, the water); the Colony's 86 m rear wall; the middle house
       of the west terrace. What ARRIVED: the Training Ground (turf, pitch
       lines, two goals, a two-storey clubhouse with its switchback, benches,
       hurdles, nets), four wall stubs, the terrace passage furniture, and the
       stadium's tiers grown from 1.1 to 2.0 m (same count, taller). The bus
       helper's roof now meets its glass band on every bus on the map.
       draws 99 -> 99, casters 62 -> 62, lights 7 -> 7: no new material or
       cast combination was minted. tris 128528 -> 127780: the ship cost more
       than the clubhouse. Signatures re-recorded from the build. */
  /* v1.0e: THE TALL OPERATOR'S LINTELS. world.js liftLintels() raises every
     doorway header it can prove is over an opening to 2.65 m (67 on urban)
     and removes the thin facade header bands that would be left as slivers,
     so the 2.28 m rendered operator no longer walks through door frames.
     Colliders move with their meshes; colSig/meshSig change on every map with
     doorways under 2.55 m — urban, sunsetrow, bazaar, substation, riverside,
     airfield. metro (3.2 m doors), killhouse and freightyard are untouched. */
  /* v1.0e: THE TRAIN. The loop line (rails + sleepers along CFG.TRAIN.urban's
     path, non-colliding), the station hall's third floor (+30 colliders: F3
     walls, the new roof and its flight), the two island lamps moved out of
     Track 2, the two boulevard containers gone. tris 127.5k -> 133.1k against
     the 136k budget: the rails are ~5.5k of that. */
  ...
  /* v1.1: THE WESTERN REACH and five-storey towers — +702 colliders, +18.9k tris,
     ...
     247 -> 296. */
  /* ===== v2.0: THE OUTER CITY — re-recorded as a decision (see
     verify-untouched.js for the itemised figures). colliders 5160 -> 9283,
  ...
  sunsetrow: { colliders: 288, draws: 41, tris: 7084, casters: 19, lights: 3, bound: 46, colSig: 520756720, meshSig: -437825621 },
...
/* v1.0d: bazaar's caravanserai court filled (four stalls, two carts, pallets,
   drums, two screens, cloth lines) after Rahul's "wasting space" screenshot.
   +36 colliders, +1 draw (the cart tyres' material), +1 caster. */
bazaar     : { colliders: 359, draws: 25, tris: 11764, casters: 11, lights: 3, bound: 46, colSig: -1074009172, meshSig: 1691668726 },
substation : { colliders: 254, draws: 24, tris: 10392, casters: 14, lights: 3, bound: 40, colSig: -9101380, meshSig: -768507913 },
  ...
  riverside  : { colliders: 383, draws: 34, tris: 10572, casters: 24, lights: 3, bound: 66, colSig: -61579834, meshSig: 40011342 },
  airfield   : { colliders: 312, draws: 34, tris: 8740, casters: 19, lights: 3, bound: 70, colSig: 1289989088, meshSig: -1116298994 }
};
