# Urban Strike — Handoff (v10.16 shipped)

Upload this file plus `urban-strike-v10.16.zip` into a new chat.
...
> (expect 38) and `curl -s <host>/version`. v10.16.0 verified on both.
