(function (root, factory) {
  ...
  var SPAWNS = [
    ...
    /* v2.0: THE OUTER CITY — 28 spawns on its cross streets, plazas and the inner
       avenue, probed against the built map (tools/_v2points.js), both sides. */
    [-230, -166, 3.14, "n"], [-150, -166, 3.14, "n"], [-60, -166, 3.14, "n"], [30, -166, 3.14, "n"],
    [110, -166, 3.14, "n"], [170, -166, 3.14, "n"], [-230, 166, 0, "n"], [-150, 166, 0, "n"],
    [-60, 166, 0, "n"], [30, 166, 0, "n"], [110, 166, 0, "n"], [170, 166, 0, "n"],
    [166, -60, 1.57, "n"], [166, 60, 1.57, "n"], [-226, -60, -1.57, "n"], [-226, 60, -1.57, "n"],
    [-30, -197, 0, "n"], [-30, 197, 0, "n"], [197, 0, 0, "n"], [-257, 0, 0, "n"],
