(function (root, factory) {
  ...
  var WEAPONS = {
    ...
    sniper:  { key: 9, ex: 1, label: 'AWM-S', type: 'bolt', dmg: 88, rpm: 42, mag: 5, reserve: 25, reload: 3.2, spread: 0.0015, ads: 0.0004, range: 999, head: 2.0, legs: 0.6, speed: 0.85, recoil: 0.03, drift: 0.2, adsFov: 16, scope: true, boltTime: 1.25, scopeZoom: [10, 26], bullet: true, bulletSpeed: 240, bulletDrop: 4.2, sway: 0.0038, trc: 0xcfe8ff },
