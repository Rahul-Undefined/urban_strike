(function (root, factory) {
  ...
  var LOOT_POINTS = [
    ...
    [0, 0.55, -74, "g"], [79, 3.15, -4, "h"], [88, 0.55, -10, "g"],
    ...
    [77, 3.85, -26.6, "h"], [66, 6.80, -33.0, "s"], [69, 1.65, -45.4, "h"],
    [66, 1.47, -16.2, "g"], [-67.5, 0.55, -28.0, "h"], [-61.5, 0.55, -21.0, "h"], [-55.5, 0.55, -36.0, "h"],
    [-58.5, 3.15, -26.5, "h"], [-63.0, 9.95, -30.5, "s"], [-32.0, 1.65, -17.7, "h"],
    ...
    [-77.3, 0.8, -87.8, "h"], [-77.3, 0.8, -81.8, "h"], [-81.8, 3.8, -90.8, "h"], [-81.8, 3.8, -84.8, "h"],
    ...
    [51.2, 3.8, -26.3, "h"], [60.7, 3.8, -26.3, "h"], [70.2, 3.8, -26.3, "h"], [57.7, 0.8, 61.2, "h"], [66.7, 0.8, 61.2, "h"], [77.2, 0.8, 65.2, "h"],
  ...
  ,
    ...
    [2, 4.75, -109.6, "h"], [2, 8.95, -109.6, "h"], [0, 21.80, -112.6, "s"],           // NORTH   (x -4..4,  z -118.6..-106.6)
    [32, 4.75, 115.6, "h"], [32, 8.95, 115.6, "h"], [30, 21.80, 112.6, "s"],           // SOUTH   (x 26..34, z 106.6..118.6)
    [113.4, 4.75, 3, "h"], [113.4, 8.95, 3, "h"], [111.4, 21.80, 0, "s"],              // EAST    (x 107.4..115.4, z -6..6)
    [-113.4, 4.75, 15, "h"], [-113.4, 8.95, 15, "h"], [-111.4, 21.80, 12, "s"],        // WEST    (mirrored, x -115.4..-107.4, z 6..18)
    // north yards: single container roofs at 2.6 and the stacked seconds at 5.2
    [-87.2, 5.75, -116.4, "h"], [14.8, 5.75, -116.4, "h"], // barracks watchtower deck (top 3.25)
    [-113.5, 3.80, 79, "h"],
    /* v1.1: THE WESTERN REACH (x -180..-120). Ground points on the streets and in
       the yards; roof points only where a block has its outside stair. */
    [-154, 0.55, -72, "g"], [-134, 0.55, -74, "g"], [-146, 0.55, -50, "g"], [-130, 0.55, -62, "g"], [-156, 0.55, -44, "s"],   // West Docks
    [-154, 7.45, -85, "h"], [-134, 7.45, -87, "h"],                                                                             // warehouse roofs (stairs on the north walls)
    [-146, 0.55, -8, "g"], [-146, 0.55, 8, "g"], [-140, 0.55, -20, "g"], [-140, 0.55, 20, "g"], [-156, 0.55, 0, "s"],         // Harbour Market square
    [-156, 7.45, -16, "h"], [-130, 4.15, 0, "h"],                                                                               // hall roof, the exchange roof
    [-158, 0.55, 64, "g"], [-144, 0.55, 40, "g"], [-128, 0.55, 64, "g"], [-149, 0.55, 80, "s"],                                 // Mill Row
    [-158, 7.45, 46, "h"], [-149, 7.45, 70, "h"],                                                                               // house roof, mill roof
    [-170, 0.55, -60, "g"], [-170, 0.55, 60, "g"], [-176, 0.55, 0, "g"]                                                          // the new west boulevard
  ];

  var AIRDROP = {
    periodSec: 100, fallSec: 4,   /* v1.0z: 150 -> 100 (Rahul: "drop ko frequent karo") */
    ...
    /* v1.0z (Rahul: "jo common hai usko drop mein dena zaroori nahi — sirf
       exclusive items"): helm_3 and medkit are floor loot; out. What a crate
       holds now is what a crate is for: drones, launchers, the EMP, the
       shield, C4, the 8x, the visor, molotovs. */
    exoticPool: ['drone', 'drone', 'wpn_rocket', 'molotov', 'att_x8', 'visor', 'wpn_seeker',
