...
var UI = (function () {
  ...
  /* v2.0: the nuke, rocket-ladder and visor-HUD block that stood here is gone
     with the kill-streak strikes; the visor pip lives below (setVisorHud). */
  ...
  return {
    ...
    setVisorHud: setVisorHud,
    setShield: setShield,   /* v15.0 */
