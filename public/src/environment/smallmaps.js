...
(function () {
  ...
  World._buildBazaar = function (T) {
    ...
    /* v1.0d (Rahul, screenshot from inside the court: "wasting space"): the
       caravanserai was a well and two benches in a 44 x 8 m yard. It is a
       MARKET now — four stalls, two carts, pallet stacks, drums, and two
       waist-high screens that cut the 44 m sightline into three rooms. */
    stall(-16, -27.3, 0, CLOTH[0]); stall(16, -27.3, 0, CLOTH[2]);
    stall(-6.5, -30.0, 1.5708, CLOTH[4]); stall(6.5, -24.6, 1.5708, CLOTH[1]);
    [[-11, -25.2], [11, -29.6]].forEach(function (c) {          // hand carts: bed, rails, two wheels
      K.box(c[0], 0.55, c[1], 2.2, 0.16, 1.2, M.wood); K.box(c[0], 0.95, c[1] - 0.55, 2.2, 0.6, 0.08, M.wood);
      K.box(c[0], 0.95, c[1] + 0.55, 2.2, 0.6, 0.08, M.wood); K.box(c[0], 0.8, c[1], 1.4, 0.35, 0.9, M.cargoWood, K.NCAST);
      K.cyl(c[0] - 0.9, 0.4, c[1] + 0.75, 0.4, 0.14, M.tire, K.NCAST); K.cyl(c[0] + 0.9, 0.4, c[1] + 0.75, 0.4, 0.14, M.tire, K.NCAST);
    });
    K.pallets(-19.5, -30.2, 3); K.pallets(19.5, -24.4, 3); K.drums(-3.5, -30.4, 3); K.drums(3.5, -24.2, 2);
    K.seg(-9.5, -3.5, 0, 1.2, -27.5, -27.2, M.plaster); K.seg(3.5, 9.5, 0, 1.2, -27.5, -27.2, M.plaster);
    K.seg(-21, 21, 3.4, 3.5, -28.9, -28.7, M.maroon, K.NBOTH); K.seg(-21, 21, 3.4, 3.5, -25.9, -25.7, M.ochre, K.NBOTH);   // cloth lines
