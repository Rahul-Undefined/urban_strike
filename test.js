...
function phase19() {
  ...
  /* --- v1.0d: the arena redeploy ladder --- */
  {
    ...
    ok(r(10) === 13 && r(15) === 17 && r(19) === 22 && r(20) === 30 && r(60) === 30,
      'and keeps climbing to the 30 s ceiling at the 20th death [' + [10, 15, 19, 20, 60].map(r).join(',') + ']');
    ok(CFG.respawnDelayFor('riverside', 20) === 30 && CFG.respawnDelayFor('bazaar', 5) === 8, 'medium and small maps both climb');
