# Urban Strike — Handoff (v10.14 shipped)

Upload this file plus `urban-strike-v10.14.zip` into a new chat.
...
> (expect 38) and `curl -s <host>/version`. v10.14.0 verified on both.
